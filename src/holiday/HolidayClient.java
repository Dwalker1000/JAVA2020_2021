...
public class HolidayClient {
    public static void main(String [] args){
        ...
        do {
            ...
            if (xyz == 1) {
                ...
                if (x == 10) {
                    System.out.println(holiday.AvgDay());
                }
                if (x == 11) {
    ...
    public static void menu(){
        ...
        System.out.println("* 2. See name.Name                    *");
        System.out.println("* 3. Change name.Name                 *");
        ...
        System.out.println("* 8. Full holiday.Holiday                *");
    ...
    public static void newHoliday(Holiday holiday, Scanner scan){
        System.out.println("what is your holiday.Holiday's name");
        String name = scan.next();
        holiday.ChangeName(name);
        System.out.println("what day is your holiday.Holiday on");
        int day = scan.nextInt();
        holiday.ChangeDay(day);
        System.out.println("what month is your holiday.Holiday in");
